...
python -m romp.main --mode=video --calc_smpl --render_mesh --show_items=tracking,mesh -i=D:/110598028/input_video_dataset/run_away/president_weihan_more.mp4 -o=D:/110598028/ROMP/output/president_weihan_more/results.mp4 --save_video -t -sc=3. --onnx
python -m romp.main --mode=video --calc_smpl --render_mesh --show_items=tracking,mesh -i=D:/110598028/input_video_dataset/run_away/str_network_short.mp4 -o=D:/110598028/ROMP/output/str_network_short/results.mp4 --save_video -t -sc=3. --onnx
