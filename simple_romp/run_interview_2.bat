...
python -m bev.main -m video --calc_smpl --temporal_optimize --smooth_coeff 0.2  -i=D:\110598028\input_video_dataset\three_person_refine.mp4 -o=../output/three_person_refine_bev/three_person_refine_bev_result.mp4 --save_video --GPU 0
